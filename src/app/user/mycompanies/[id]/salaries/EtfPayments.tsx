...
import { fetchEtfPayments, deleteEtfPayment } from "@/app/lib/api";
import dayjs from "dayjs";
import EtfPaymentDialog from "./EtfPaymentDialog";

export const EtfPayments: React.FC<{
    ...
    const {
        ...
        queryKey: ["etf-payments", companyId, paginationModel.page, paginationModel.pageSize, searchQuery],
        queryFn: () => fetchEtfPayments({
            companyId,
    ...
    const deleteMutation = useMutation({
        mutationFn: async (id: string) => deleteEtfPayment(id),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["etf-payments"] });
